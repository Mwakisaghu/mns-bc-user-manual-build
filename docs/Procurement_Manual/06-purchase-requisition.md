...
<div class="purchase-requisition-section">
    <h2 class="purchase-requisition-intro-heading">
    Objective: Create and process purchase requisitions for required goods or services.
    </h2>
</div>
